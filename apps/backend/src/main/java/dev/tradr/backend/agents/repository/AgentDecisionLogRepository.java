...
public interface AgentDecisionLogRepository extends JpaRepository<AgentDecisionLog,Long>{ List<AgentDecisionLog> findByAgentIdOrderByTimestampDesc(UUID agentId, Pageable pageable); List<AgentDecisionLog> findByAgentIdInOrderByTimestampDesc(Collection<UUID> agentIds, Pageable pageable); }
